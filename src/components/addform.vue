      ...
      <div v-if="!formalert">
        <div>
          <div class="btnatas mt-3 my-lg-3">
            ...
            <button v-show="uptbtn" @click="upttog" class="button-31">
              ...
              <div class="rose shadow">
                <div class="mawar">
                  <div class="form-group row">
                    <label
                      for="inputPassword"
                      class="col-sm-7 col-form-label mt-2 fw-bold"
                      >Nomor Kartu Keluarga</label
                    >
                    <div class="col-sm-12">
                      <input
                        v-model="kakadata.nomor_kk"
                        type="number"
                        class="form-control"
                        id="inputNomor"
                        :disabled="noKK"
                        ...
                        placeholder="No KK"
                      />
                      <p v-if="validate" class="textvalidate">
                        <small>
                          Mohon Maaf! Nomor Kartu Keluarga Sudah Digunakan
                        </small>
                      </p>
                    </div>
                  </div>
                  ...
                  <div class="d-flex">
                    <div class="form-group row">
                      <label
                        for="inputRt"
                        class="col-sm-2 col-form-label mt-5 fw-bold"
                        >Rt</label
                      >
                      <div class="col-sm-5">
                        <input
                  ...
                  <div>
                    <div
                      class="d-flex justify-content-left mx-4 mb-3 mb-lg-4 mt-5"
                    >
                      <button
                        type="button"
                        v-show="updateShow"
                      ...
                      <button
                        v-show="title == 'Tambah'"
                        class="btn btn-18 btn-lg"
                      >
                        {{ buttonValue }}
                      </button>

                      <button v-show="updateShow" class="btn btn-19">
                        {{ buttonValue }}
                      </button>
                    </div>
                  </div>
                ...
                <div class="melati">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-12">
                      <input
                        v-model="kakadata.desa_kelurahan"
                        type="text"
                        class="form-control"
                        id="inputdesa"
                        required
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-12">
                      <input
                        v-model="kakadata.kabupaten_kota"
                        type="text"
                        class="form-control"
                        id="inputRw"
                        required
...
.btn:focus {
  box-shadow: black 0 0 0 1.5px inset, rgba(45, 35, 66, 0.4) 0 2px 4px,
    rgba(45, 35, 66, 0.3) 0 7px 13px -3px, black 0 -3px 0 inset;
}
