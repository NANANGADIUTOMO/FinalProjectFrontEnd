          ...
          <div class="rose shadow">
            <div class="mawar">
              <div class="form-group row">
                ...
                <div class="col-sm-12">
                  ...
                  />
                  <p v-if="validate2" class="textwarning">
                    <small>Maaf! Nomor NIK Anda Sudah Digunakan</small>
                  </p>
                </div>
              </div>
              <div class="form-group row">
              ...
              <div class="form-group row">
                <div class="col-sm-12 col-form-label mt-2 fw-bold">
                  ...
                  <div class="col-sm-12">
                    <select
                      v-model="datakeluarga.jenis_kelamin"
              ...
              <div class="form-group row">
                <label
                  for="inputPassword"
                  class="col-sm-7 col-form-label mt-3 fw-bold"
                  required
                  >Tempat Lahir</label
                >
                <div class="col-sm-12">
              ...
              <div>
                <div class="d-flex justify-content-left mx-4 mb-3 mb-lg-4 mt-3">
                  <button
                    ...
                    v-show="updtShow"
                    @click="kancel"
                    class="btn btn-21 btn-lg"
                  >
                    Batal
                  </button>

                  <button v-show="title == 'Tambah'" class="btn btn-14 btn-lg">
                    {{ buttonValue }}
                  </button>

                  <button v-show="updtShow" @click="clikk" class="btn btn-20">
                    {{ buttonValue }}
                  </button>
                </div>
              </div>
            ...
            <div class="melati">
              <div class="form-group row">
                ...
                <div class="col-sm-12">
                  <input
                    v-model="datakeluarga.tanggal_lahir"
                    type="date"
                    class="form-control"
                    id="inputdesa"
                    :disabled="!disable"
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-12">
                  <input
                    v-model="datakeluarga.pendidikan"
                    type="text"
                    class="form-control"
                    id="inputRw"
                    :disabled="!disable"
              ...
              <div class="form-group row">
                <label
                  for="inputPassword"
                  class="col-sm-7 col-form-label mt-4 fw-bold"
                  >Kepala Keluarga</label
                >
                <div class="col-sm-12">
                  <select
                    v-model="datakeluarga.kepala_keluarga"
                    class="form-control"
                    required
                    :disabled="!disable"
